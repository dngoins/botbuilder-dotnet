    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddBot<EchoBot>(options =>
            {
                ...
                var translatorKey = Configuration.GetSection("TranslatorKey")?.Value;
                ...
                middleware.Add(new TranslationMiddleware(new string[] { "en" }, translatorKey, patterns, TranslatorLocaleHelper.GetActiveLanguage,
                    TranslatorLocaleHelper.CheckUserChangedLanguage));
                middleware.Add(new LocaleConverterMiddleware(TranslatorLocaleHelper.GetActiveLocale, TranslatorLocaleHelper.CheckUserChangedLocale,
